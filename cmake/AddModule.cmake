function(AddModule MODULE_NAME)
	...
	string(APPEND LOCAL_MODULE_INCLUDES "${ENGINE_MODULE_INCLUDES}#include \"${MODULE_NAME}/${MODULE_NAME}.hpp\"\n")
    string(APPEND LOCAL_MODULE_INIT_FUNCS "${ENGINE_MODULE_INIT_FUNCS}${MODULE_NAME}::Initialize();\n")
    string(APPEND LOCAL_MODULE_DEINIT_FUNCS "${ENGINE_MODULE_DEINIT_FUNCS}${MODULE_NAME}::Deinitialize();\n")
